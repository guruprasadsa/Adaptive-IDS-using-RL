    ...
    <div class="alerts-toolbar">
        <div class="filter-group">
            <div class="search-wrapper">
                ...
                <input type="search" id="alert-search-input" placeholder="Search alerts..." value="${state.filters.search}" aria-label="Search alerts" class="search-input">
            </div>
            <select id="priority-filter" aria-label="Filter by priority" class="filter-select" data-filter="priority">
            ...
            <select id="status-filter" aria-label="Filter by status" class="filter-select" data-filter="status">
...
const renderAlertsTable = (alerts: Alert[], state: AlertsState): HTMLElement => {
    ...
    const statusClasses: Record<Alert['status'], string> = {
        new: 'status-new', investigating: 'status-investigating', resolved: 'status-resolved', false_positive: 'status-closed',
    };
